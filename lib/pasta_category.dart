...
class pasta_category extends StatefulWidget {
  @override
  _pasta_category createState() => _pasta_category();
}

class _pasta_category extends State<pasta_category> {
  ...
  Future<List<Item>> _fetchCakeItems() async {
    QuerySnapshot<Map<String, dynamic>> snapshot =
        await FirebaseFirestore.instance.collection('Pasta_category').get();
  ...
  void _onItemTap(String itemName) {
    switch (itemName) {
      case 'Cheese Pasta':
        _navigateToBurger('Pasta_category', 'item_1');
        break;
      case 'Crunchy Pasta':
        _navigateToBurger('Pasta_category', 'item_2');
        break;
      case 'Chicken Cheese':
        _navigateToBurger('Pasta_category', 'item_3');
        break;
      case 'Red Sauce':
        _navigateToBurger('Pasta_category', 'item_4');
        break;
      case 'Chicken Pasta':
        _navigateToBurger('Pasta_category', 'item_5');
        break;
      default:
        _navigateToBurger('Pasta_category', 'item_6');
        break;
    }
  }
