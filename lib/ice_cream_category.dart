...
class ice_cream_category extends StatefulWidget {
  @override
  _ice_cream_category createState() => _ice_cream_category();
}

class _ice_cream_category extends State<ice_cream_category> {
  ...
  Future<List<Item>> _fetchCakeItems() async {
    QuerySnapshot<Map<String, dynamic>> snapshot =
        await FirebaseFirestore.instance.collection('Ice_cream_category').get();
  ...
  void _onItemTap(String itemName) {
    switch (itemName) {
      case 'Mango':
        _navigateToBurger('Ice_cream_category', 'item_1');
        break;
      case 'Vanilla':
        _navigateToBurger('Ice_cream_category', 'item_2');
        break;
      case 'Oreo':
        _navigateToBurger('Ice_cream_category', 'item_3');
        break;
      case 'Chocolate':
        _navigateToBurger('Ice_cream_category', 'item_4');
        break;
      case 'Pistachio':
        _navigateToBurger('Ice_cream_category', 'item_5');
        break;
      default:
        _navigateToBurger('Ice_cream_category', 'item_6');
        break;
    }
  }
