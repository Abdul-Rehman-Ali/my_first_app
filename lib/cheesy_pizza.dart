...
class cheesy_Pizza extends StatefulWidget {
  @override
  _cheesy_Pizza createState() => _cheesy_Pizza();
}

class _cheesy_Pizza extends State<cheesy_Pizza> {
  int quantity = 0;
  String selectedSize = '';
  ...
  Future<void> _fetchPizzaDetails() async {
    try {
      ...
      await Future.delayed(
          Duration(seconds: 1)); // Simulate a 1-second loading time
