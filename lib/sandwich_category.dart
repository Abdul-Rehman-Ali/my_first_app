...
class sandwich_category extends StatefulWidget {
  @override
  _sandwich_category createState() => _sandwich_category();
}

class _sandwich_category extends State<sandwich_category> {
  ...
  Future<List<Item>> _fetchDrinkItems() async {
    QuerySnapshot<Map<String, dynamic>> snapshot =
        await FirebaseFirestore.instance.collection('Sandwich_category').get();
  ...
  void _onItemTap(String itemName) {
    switch (itemName) {
      case 'Chicken Sandwich':
        _navigateToBurger('Sandwich_category', 'item_1');
        break;
      case 'Egg Chicken':
        _navigateToBurger('Sandwich_category', 'item_2');
        break;
      case 'Cheese Sandwich':
        _navigateToBurger('Sandwich_category', 'item_3');
        break;
      case 'Vegetables':
        _navigateToBurger('Sandwich_category', 'item_4');
        break;
      case 'Egg Sandwich':
        _navigateToBurger('Sandwich_category', 'item_5');
        break;
      default:
