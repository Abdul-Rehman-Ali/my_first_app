...
class cake_category extends StatefulWidget {
  @override
  _cake_category createState() => _cake_category();
}

class _cake_category extends State<cake_category> {
  ...
  Future<List<Item>> _fetchCakeItems() async {
    QuerySnapshot<Map<String, dynamic>> snapshot =
        await FirebaseFirestore.instance.collection('Cake_category').get();
  ...
  void _onItemTap(String itemName) {
    switch (itemName) {
      case 'Black Forest':
        _navigateToBurger('Cake_category', 'item_1');
        break;
      case 'Pineapple Cake':
        _navigateToBurger('Cake_category', 'item_2');
        break;
      case 'Strawberry Cake':
        _navigateToBurger('Cake_category', 'item_3');
        break;
      case 'Chocolate Cake':
        _navigateToBurger('Cake_category', 'item_4');
        break;
      case 'Butter Scotch':
        _navigateToBurger('Cake_category', 'item_5');
        break;
      default:
        _navigateToBurger('Cake_category', 'item_6');
        break;
    }
  }
