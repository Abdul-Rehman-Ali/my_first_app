...
class burger_category extends StatefulWidget {
  @override
  _burger_category createState() => _burger_category();
}

class _burger_category extends State<burger_category> {
  ...
  Future<List<Item>> _fetchPizzaItems() async {
    QuerySnapshot<Map<String, dynamic>> snapshot =
        await FirebaseFirestore.instance.collection('Burger_category').get();
  ...
  void _onItemTap(String itemName) {
    switch (itemName) {
      case 'Double Cheese':
        ...
        break;
      case 'Beef Burger':
        _navigateToBurger('Burger_category', 'item_2');
        break;
      case 'Zinger Burger':
        _navigateToBurger('Burger_category', 'item_3');
        break;
      case 'Chicken Supremes':
        _navigateToBurger('Burger_category', 'item_4');
        break;
      case 'Chicken Burger':
        _navigateToBurger('Burger_category', 'item_5');
        break;
      default:
        _navigateToBurger('Burger_category', 'item_6');
        break;
    }
  }
