...
void main() {
  runApp(periPeri_Pizza());
}

class periPeri_Pizza extends StatefulWidget {
  @override
  _periPeri_Pizza createState() => _periPeri_Pizza();
}

class _periPeri_Pizza extends State<periPeri_Pizza> {
  int quantity = 0;
  String selectedSize = '';
